...
extern C_ROCKSDB_LIBRARY_API void crocksdb_options_set_bytes_per_sync(
    crocksdb_options_t*, uint64_t);
extern C_ROCKSDB_LIBRARY_API void
crocksdb_options_set_enable_pipelined_write(crocksdb_options_t*enable_write_thread_adaptive_yield,
                                                    unsigned char);   
extern C_ROCKSDB_LIBRARY_API void
crocksdb_options_set_allow_concurrent_memtable_write(crocksdb_options_t*enable_write_thread_adaptive_yield,
                                                    unsigned char);
extern C_ROCKSDB_LIBRARY_API void
